...
export default function GigsPagesContainer(props) {
  ...
  return (
    <div>
      <Helmet>
        <title>“Gig Work | Topcoder Community | Topcoder”</title>
        <meta name="description" content=“Compete and build up your profiles and skills! Topcoder members become
eligible to work on Gig Work projects by first proving themselves in various
skill sets through Topcoder competitions.”>
