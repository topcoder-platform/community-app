  ...
  return (
    <main>
      ...
      <Banner
        ...
        imageSrc="/community-app-assets/themes/srmx/learn/banner.jpg"
      />
        ...
        <Accordion>
          ...
          <AccordionItem title="Payment & Rewards">
            <Text>
              ...
              <p>
                If  you&apos;d like to work on challenges, check out what&apos;s active on the
                <a href="challenges">
                  challenges
                </a>
                {' '}
                page.  If there is nothing active, send us a note and tell us to stop slacking! :)
              </p>
              <div styleName="joinnowWrap">
                <Link styleName="joinnow" to="learn">
                  Join Now
          ...
          <AccordionItem title="Managing your Badges">
            <Text>
              <p>
                Make sure you&apos;ve setup your payment preferences at https://community.topcoder.com/PactsMemberServlet?module=PaymentHistory.  When you&apos;ve earned some money and want to withdraw it, you can do that at https://community.topcoder.com/PactsMemberServlet?module=PaymentHistory&full_list=false
              </p>
            </Text>
          </AccordionItem>
      ...
      >
        <ArticleCard
          ...
          imageSrc="/community-app-assets/themes/srmx/learn/courses-01.jpg"
        />
        <ArticleCard
          ...
          imageSrc="/community-app-assets/themes/srmx/learn/courses-02.jpg"
        />
        <ArticleCard
          ...
          imageSrc="/community-app-assets/themes/srmx/learn/courses-03.jpg"
        />
      </Section>
      ...
      <NewsletterSignup
        ...
        imageSrc="/community-app-assets/themes/srmx/subscribe-bg.jpg"
      />
    </main>
  );
}
