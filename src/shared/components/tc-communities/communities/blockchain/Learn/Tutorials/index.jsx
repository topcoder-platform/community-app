          ...
          <ul>
            <li>
              <a
                ...
                target="_blank"
              >Create your own crypto-currency with Ethereum</a>
            </li>
            <li>
              <a
                ...
                rel="noopener noreferrer"
                target="_blank"
              >Crowdsale. Raising funds from friends without a third party</a>
            </li>
            <li>
              <a
                ...
                rel="noopener noreferrer"
                target="_blank"
              >How to build a democracy on the blockchain</a>
            </li>
            <li>
              <a
            ...
            <li>
              <a
                ...
                rel="noopener noreferrer"
                target="_blank"
              >Building robust smart contracts with OpenZeppelin</a>
            </li>
            <li>
              <a
                ...
                rel="noopener noreferrer"
                target="_blank"
              >Building dApps for Quorum: Private enterprise blockchains</a>
            </li>
            <p>
            ...
            <div styleName="videos">
              <div styleName="video-block">
                <p>
                  Introduction, and walkthrough <em>&ldquo;Ethereum pet
                  shop&rdquo;</em> and <em>&ldquo;Building robust smart
                  contracts with OpenZppellin&rdquo;</em> tutorials from
                  &zwnj;<a
