        ...
        >
          <Accordion>
            ...
            <AccordionItem title="Is there a role or band restriction for participation?">
              <Text><p>No role restrictions or band restrictions for participating in challenges.</p></Text>
            </AccordionItem>
            <AccordionItem title="Where can I see challenges and participate in the same?">
              <Text><p>In Home page click on Challenges; Look for challenges that are still open for registration. Click on the Challenge to see skills/technology involved and other details; Register to participate in the challenge OR go through video</p></Text>
            </AccordionItem>
            <AccordionItem title="Can I participate in more than one challenge simultaneously?">
              <Text><p>Yes you can participate in more than one challenge simultaneously</p></Text>
            </AccordionItem>
            <AccordionItem title="Where can I see prize and TopGear points for challenge?">
              <Text><p>Each challenge details will have details about winner prize and TopGear points associated</p></Text>
            </AccordionItem>
            ...
            <AccordionItem title="How can I enhance my skills available on platform and get hands on experience?">
              <Text><p>In Home page click on Learning; Navigate to communities; Join a community where you want to enhance your skills; Join training/case study projects and complete the same.</p></Text>
            </AccordionItem>
            <AccordionItem title="Will my resume gets updated for enhancing my skill and participating in challenges?">
              <Text><p>Yes. The resume gets updated automatically after approval of submissions corresponding to training/case study and challenge.</p></Text>
            </AccordionItem>
            <AccordionItem title="Can I avail overtime benefits, for utilizing my time for participating in challenges?">
              <Text><p>No. Contribution time in participating will not be considered for over-time benefits.</p></Text>
            </AccordionItem>
            ...
            <AccordionItem title="I have resigned from the company and I have TopGear points. What will happen to them?">
              <Text><p>If you are eligible for periodic contest – spot awards and you are exiting prior to contest/promotion scheduled date, the points get lapsed.</p></Text>
            </AccordionItem>
            <AccordionItem title="How the TopGear points earned do reflected in TrendNxt credits?">
              <Text><p>TopGear contribution credits are considered under Organization Contribution category of TrendNxt.</p></Text>
            </AccordionItem>
            <AccordionItem title="If I am not eligible/exempted from TrendNxt, what will happen to my TopGear points?">
              <Text><p>TopGear points earned may be considered for periodic contests.</p></Text>
            </AccordionItem>
            ...
            <AccordionItem title="I am interested to contribute as Challenge Architect / Co-Pilot / Reviewer, what is the process?">
              <Text>
                <p>Send a mail to ask.topgear@wipro.com and TopGear team will get back to you with details.  a.  User could also register on link
                &zwnj;<a href="https://topgear-app.wipro.com/topcoder_reviewer/registration">https://topgear-app.wipro.com/topcoder_reviewer/registration</a>
                </p>
              </Text>
            </AccordionItem>
            ...
            <AccordionItem title="I would like to create a new group that I can post challenges and tasks to. How do I get that setup?">
              <Text><p>Submit a request at <a href="https://help.topcoder.com/hc/en-us/requests/new?ticket_form_id=779747">https://help.topcoder.com/hc/en-us/requests/new?ticket_form_id=779747</a> and a TopGear team member will help get it setup.</p></Text>
            </AccordionItem>
