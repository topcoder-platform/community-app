          ...
          <div styleName="wrap">
            ...
            <div styleName="form-wrap">
              ...
              <div styleName="form-section">
                <div styleName="form-row">
                  <TextInput
                    placeholder="Weekly Pay Expectation (eg. $500)"
                    label="Weekly Pay Expectation"
                    onChange={val => onFormInputChange('payExpectation', val)}
                    errorMsg={formErrors.Expectation}
                  />
                  <Datepicker
                    placeholder="Available From"
                    label="Available From"
                    onChange={val => onFormInputChange('availFrom', val)}
              ...
              <button type="button" styleName="primaryBtn" onClick={onApplyClick} disabled={!_.isEmpty(formErrors)}>
                APPLY TO THIS JOB
              </button>
            </div>
          </div>
