          ...
          <tbody>
            {
              challengesOrdered.map(challenge => (
                <tr styleName="row" key={`${challenge['tco_leaderboard.challenge_id'] || challenge.challenge_id}`}>
                  <td styleName="name">
                    <a href={`${config.URL.BASE}/challenges/${challenge['tco_leaderboard.challenge_id'] || challenge['challenge.challenge_id']}/`} styleName="link" target="_blank" rel="noopener noreferrer">
