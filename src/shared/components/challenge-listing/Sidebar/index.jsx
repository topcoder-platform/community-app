    ...
    for (let i = 0; i < filters.length; i += 1) {
      if (filters[i].mode === 'All Challenges') {
        ...
        for (let j = 0; j < filters.length; j += 1) {
          if (filters[j].mode === 'Open for registration'
            || filters[j].mode === 'Ongoing challenges') {
...
/*
  ...
  selectFilter(index) {
    if (this.state.filters[index].mode === 'Open for review') {
      ...
      window.location.href = `${this.props.config.MAIN_URL}
      /review/development-review-opportunities/`;
    } else {
...
*/
  ...
  selectFilterWithName(filterName) {
    ...
    if (selectedFilter.mode === 'Open for review') {
      ...
      `${this.props.config.MAIN_URL}/review/development-review-opportunities/`;
      return;
    }
