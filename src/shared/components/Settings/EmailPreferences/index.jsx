      ...
      <div styleName="email-preferences-container">
        <div className="settings-section" styleName="newsletters">
          <div className="section-info">
            ...
            <div className="description">Choose the community newsletters that you would like to receive. They are sent about once a week and have the latest news on challenges, events, and special programs.</div>
          </div>
